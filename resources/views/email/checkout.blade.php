...
>
    ...
    <body style="word-spacing: normal; background-color: #d9d9d9">
                                                            ...
                                                            <tr>
                                                                ...
                                                                >
                                                                    <img
                                                                        alt="nomads_logo"
                                                                        height="auto"
                                                                        src="{{ url('frontend/images/email/nomads_email_bg.png') }}"
                                                                        style="
                                                                            border: none;
                                                                            display: block;
                                                                            outline: none;
                                                                    ...
                                                                    >
                                                                        <tr>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                href="{{ url('detail_checkout/'. $data->id )}}"
                                                                                    style="
                                                                                        display: inline-block;
                                                                                        background: #ff7e00;
                                                                                        color: #ffffff;
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <tr>
                                                            ...
                                                            >
                                                                <img
                                                                    src="{{ url('frontend/images/email/chat_logo.png')}}"
                                                                    width="50px"
                                                                    alt="chat_image"
                                                                />
                                                            </td>
                                                            ...
                                                            >
                                                                support@nomads.id<br />021-2019-2022
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
